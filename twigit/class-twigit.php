<?php
	...
	class Twigit
	{
		...
		private function add_global_variables()
		{
			...
			self::$global_variables = apply_filters('twigit_twig_site_variables', self::$global_variables);
		...
		private function add_global_functions()
		{
			...
			self::$global_functions = apply_filters('twigit_twig_global_functions', self::$global_functions);
		...
		public function render_template($template, $vals)
		{
			 ...
			 */
			$vals = apply_filters('twigit_twig_post_template_vars', $vals);
		...
		{
			echo '<div class="error"><p><b>Warning:</b> Twigit cannot find the Twig autoloader.php file. This is required!</p></div>';
		}
